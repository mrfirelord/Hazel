...
public:
	ExampleLayer() : Layer("Example"), m_Camera(-1.6f, 1.6f, -0.9f, 0.9f), m_CameraPosition(0), m_Rotation(0) {
		...
		m_Shader = Hazel::Shader::Create("sdf", vertexSrc, fragmentSrc);
		...
		m_FlatColor = Hazel::Shader::Create("sdfsdfff", flatColorShaderVertexSrc, flatColorShaderFragmentSrc);
	...
	void OnUpdate(Hazel::Timestep ts) override {
		...
		m_Texture->Bind();
		Hazel::Renderer::Submit(m_TextureShader, m_SquareVA, glm::mat4(1.5));
...
private:
	...
	Hazel::Ref<Hazel::Shader> m_FlatColor, m_TextureShader;
