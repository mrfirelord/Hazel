...
void Sandbox2D::OnUpdate(Hazel::Timestep ts) {
...

	{
		...
		Hazel::Renderer2D::DrawQuad({ -0.8, 0, -0.1 }, { 0.1f, 0.1f }, { 0.8f, 0.0f, 0.0f, 1.0f });
		...
		Hazel::Renderer2D::DrawQuad({ -0.5, -0.5 }, { 1.0f, 1.0f }, m_CheckerboardTexture, 10.0f, {0.9f, 0.1f, 0.2f, 1.0});
